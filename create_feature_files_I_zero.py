...
def flatten_basic(file_name, geo_number, spc, aire_energy):
    ...
    # Create CSV file
    with open('basic_features_I_zero.csv', 'w', newline='') as csvfile:
    ...
    with open('/Users/berkecaliskan/Documents/Odysseus/ODYSSEUS_simulations/simulations/all_basic_features_I_zero.csv', 'a', newline='') as csvfile:
        writer = csv.writer(csvfile)
        writer.writerow(csv_data)
    return result
