...
def flatten_basic(file_name, geo_number, spc, aire_energy):
    ...
    csv_columns = ['mass_den', 'atom_num_1', 'atom_per_mol_1', 'atom_num_2', 'atom_per_mol_2',
                ...
                'atom_per_mol_5', 'mean_excit', 'thickness', 'spc', 'energy_ratio', 'sigma']
    ...
    # Create CSV file
    with open('basic_features_I_zero_variance.csv', 'w', newline='') as csvfile:
    ...
    with open('/Users/berkecaliskan/Documents/Odysseus/ODYSSEUS_simulations/simulations/all_basic_features_I_zero_variance.csv', 'a', newline='') as csvfile:
        writer = csv.writer(csvfile)
        writer.writerow(csv_data)
    return result
